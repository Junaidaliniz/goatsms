...
async function getNumbers() {
  const url =
    ...
    `frange=&fclient=&sEcho=1&iColumns=8&sColumns=%2C%2C%2C%2C%2C%2C%2C&iDisplayStart=0&iDisplayLength`;
...
async function getSMS() {
  const url =
    ...
    `0&iDisplayLength=25&mDataProp_0=0&sSearch_0`;
